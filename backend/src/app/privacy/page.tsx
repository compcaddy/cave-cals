export default function Privacy() {
  return <main>
    ...
    <p>Apple processes payments and provides subscription transaction information. RevenueCat provides subscription offerings, paywall services, entitlement status, and purchase restoration; it receives an anonymous app identifier, purchase information, and paywall interactions. Vercel hosts our web and API services, Neon hosts service records, OpenAI processes selected AI media and public meal links, FatSecret provides food and restaurant nutrition data, and Open Food Facts provides barcode product data. Each provider processes information under its own terms and privacy policy.</p>
