export default function Privacy() {
  return <main>
    ...
    <p>Your profile, calorie and macro goals, food diary and macros, saved foods, saved meals, and widget data are stored on your device and, when iCloud is enabled, in your private iCloud account using Apple CloudKit. We do not receive your iCloud credentials or control Apple's storage and security practices.</p>
    <h2>Information sent to our services</h2>
    <p>When you search for a food, your search term is sent through our backend to FatSecret for food and restaurant nutrition information. Scanned barcodes are sent directly to Open Food Facts. Our backend processes your IP address and stores a daily hash and request counters for search rate limits; it does not store your food-search text in the database. Your diary is not sent to either food provider. When you choose AI meal photo or voice logging, the selected photo, video, or audio recording is uploaded to our backend and sent to OpenAI to identify foods, transcribe audio, and estimate portions, calories, and macros. When you request a macro estimate for a food, only that food’s name, portion and calorie amount are sent to our backend and OpenAI; your full diary is not sent. When you import a meal from a link, the public URL is sent to our backend and OpenAI so the page can be searched and converted into editable meal items. AI results are estimates; review and edit them before saving.</p>
    <p>Our services process an anonymous internal identifier, device verification credentials, Apple purchase identifiers, subscription status, usage counters (including successful AI scans and an aggregate regular food-log count capped at 100), request timestamps, and technical logs needed for security, quotas, troubleshooting, and purchase validation. We do not require an email address, password, or social account to use Cave Cals.</p>
    <h2>Purchases and third parties</h2>
    <p>Apple processes payments and provides subscription transaction information. RevenueCat provides subscription offerings, paywall services, entitlement status, and purchase restoration; it receives an anonymous app identifier, purchase information, and paywall interactions. Vercel hosts our web and API services, Neon hosts service records, OpenAI processes selected AI media, food details for requested macro estimates, and public meal links, FatSecret provides food and restaurant nutrition data, and Open Food Facts provides barcode product data. Each provider processes information under its own terms and privacy policy.</p>
    <h2>Retention and deletion</h2>
    <p>We request deletion of uploaded media after processing. Temporary uploads, estimates, and upload records expire after 24 hours and scheduled cleanup normally removes them within 48 hours. Operational backups and logs may persist for a limited period for security and reliability. OpenAI, Apple, RevenueCat, Vercel, Neon, FatSecret, and Open Food Facts may retain information under their own policies.</p>
